...
# OLD Spreadsheet (Dec 2024 – Jun 2026)
APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbzwiTwiaH0pdDXjkeMP7MH70nNw-jgCffQCY4Awn5c5A8I4sF16IwMk_aqznVQVbue72A/exec"

# NEW Spreadsheet (Jul 2026 onwards)
# Spreadsheet ID: 18pDvXn2ylfdqf886D9Np6X9VjQ0-6s4QLAh95ZBHBx0
# TODO: Replace the placeholder below with your deployed Apps Script URL
APPS_SCRIPT_URL_2 = "https://script.google.com/macros/s/AKfycbzjd-yqSubZXqawTA3wtvh-a29x4cgU_FeNscSy5D6JiLCvIiILSAmyuhXIdQvGL6Ls/exec"
...
# Sheets in the OLD spreadsheet (Dec 2024 – Jun 2026) - FULL, no more data can be added
SHEETS_OLD = [
    "2024 December",
    "2025 JAN",
    "2025 FEB",
...
# Combined ordered sheet list (used for UI selectors)
SHEETS = SHEETS_OLD + SHEETS_NEW

# Mapping: sheet name → which Apps Script URL to use
SHEET_SOURCE = {sheet: APPS_SCRIPT_URL for sheet in SHEETS_OLD}
SHEET_SOURCE.update({sheet: APPS_SCRIPT_URL_2 for sheet in SHEETS_NEW})


# Function to fetch data from the correct Google Spreadsheet for a given sheet
@st.cache_data(ttl=60)  # Cache for 60 seconds
def fetch_data_from_sheets(sheet_name):
    url = SHEET_SOURCE.get(sheet_name, APPS_SCRIPT_URL)  # fallback to old sheet
    try:
        response = session.get(url, params={"action": "read", "sheet": sheet_name}, timeout=30)
